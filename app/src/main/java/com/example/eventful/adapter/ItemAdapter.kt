...
class ItemAdapter(
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.eventTitle.text = context.resources.getString(item.titleResourceId)
        holder.eventLogistics.text = context.resources.getString(item.logisticsResourceId)
